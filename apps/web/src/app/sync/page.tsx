...
export default function SyncPage() {
  ...
  return <section className="mx-auto max-w-4xl p-6 md:p-12">
    ...
    {cloud.configured && <p className="mt-3 text-sm text-[#77786f]">可安全下載 {downloadPreview.available} 筆；同 ID 衝突 {downloadPreview.conflicts} 筆；無效資料 {downloadPreview.invalid} 筆。</p>}
