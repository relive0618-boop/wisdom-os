...
export async function DELETE(request: Request, { params }: { params: Promise<{ cycleId: string }> }) { const data = await request.json().catch(() => null); return deleteCloudEntity("pdca", (await params).cycleId, data); }
